...
function karma_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'karma_social_featured', array (
        'default'               => 'on',
        'transport'             => 'refresh',
        'sanitize_callback'     => 'karma_radio_sanitize_onoff'
    ) );

   $wp_customize->add_control( 'karma_social_featured', array(
        'label'         => __( 'Display the social icons in the featured post ?', 'karma' ),
    ...
    $wp_customize->add_setting( 'karma_social_footer', array (
        'default'               => 'on',
        'transport'             => 'refresh',
        'sanitize_callback'     => 'karma_radio_sanitize_onoff'
    ) );

   $wp_customize->add_control( 'karma_social_footer', array(
        'label'         => __( 'Display the social icons in the footer ?', 'karma' ),
        'section' => 'social_links',
        'type'    => 'radio',
        'choices'    => array(
            'on'    => __( 'Yes', 'karma' ),
    ...
    $wp_customize->add_panel( 'logo', array (
        ...
        $wp_customize->add_section( 'karma_header_color_section', array (
            'title'                 => __( 'Colors', 'karma' ),
            'panel'                 => 'logo',
        ) );
    
            $wp_customize->add_setting( 'karma_header_bg_color', array (
                'default'               => '#f9f9f9',
                'transport'             => 'refresh',
                'sanitize_callback'     => 'sanitize_hex_color',
            ) );
            $wp_customize->add_control( 
                new WP_Customize_Color_Control( $wp_customize, 'karma_header_bg_color', array(
                    'label'      => __( 'Background color', 'karma' ),
                    'section'    => 'karma_header_color_section',
                    'settings'   => 'karma_header_bg_color',
                ) ) 
            );
    
            $wp_customize->add_setting( 'karma_header_text_color', array (
                'default'               => '#4D5051',
                'transport'             => 'refresh',
                'sanitize_callback'     => 'sanitize_hex_color',
            ) );
            $wp_customize->add_control( 
                new WP_Customize_Color_Control( $wp_customize, 'karma_header_text_color', array(
                    'label'      => __( 'Menu link color', 'karma' ),
                    'section'    => 'karma_header_color_section',
                    'settings'   => 'karma_header_text_color',
                ) ) 
            );
        ...
        $wp_customize->add_section( 'karma_header_cart', array (
           ...
           $wp_customize->add_control( 'header_cart_bool', array(
                ...
                'description'   => __( 'The shopping cart will only show up if you have WooCommerce installed and activated', 'karma' ),
        ...
        $wp_customize->add_section( 'karma_site_search', array (
            'title'                 => __( 'Site Search', 'karma' ),
            'Description'           => __( 'Do you want to show the search icon in the header ?', 'karma' ),
            'panel'                 => 'logo',
        ) );
           ...
           $wp_customize->add_control( 'header_search_bool', array(
                'label'   => __( 'Display search icon ?', 'karma' ),
                'section' => 'karma_site_search',
                'type'    => 'radio',
                'choices'    => array(
                    'on'    => __( 'Yes', 'karma' ),
                    'off'    => __( 'No', 'karma' )
...
//        'title'                 => __( 'Top C - 3-column Page/Post/Product', 'karma' ),
//        'panel'                 => 'homepage',
//    ) );
//    
//    
...
//            'label'         => __( 'Display Homepage Top C Widget ?', 'karma' ),
//            'description'   => __( 'This widget shows up if you have the Static Front Page set to "A static page" in customizer -> Frontpage -> Static Front Page', 'karma' ),
...
//            ) );
//    
//            $wp_customize->add_setting( 'karma_the_featured_post4', array (
//                'default'               => 1,
//                'transport'             => 'refresh',
//                'sanitize_callback'     => 'karma_sanitize_post',
//            ) );
//            $wp_customize->add_control( 'karma_the_featured_post4', array(
//                'type'                  => 'select',
//                'section'               => 'homepage_features',
//                'label'                 => __( 'Select the Featured Post', 'karma' ),
//                'choices'               => karma_all_posts_array(),
//            ) );
//    
//            $wp_customize->add_setting( 'karma_the_featured_post5', array (
//                'default'               => 1,
//                'transport'             => 'refresh',
//                'sanitize_callback'     => 'karma_sanitize_post',
//            ) );
//            $wp_customize->add_control( 'karma_the_featured_post5', array(
//                'type'                  => 'select',
//                'section'               => 'homepage_features',
//                'label'                 => __( 'Select the Featured Post', 'karma' ),
//                'choices'               => karma_all_posts_array(),
//            ) );
//            
//            $wp_customize->add_setting( 'homepage_features_button', array (
//                'default'               => __( 'Learn more', 'karma' ),
//                'transport'             => 'refresh',
//                'sanitize_callback'     => 'sanitize_text_field',
//            ) );
//            $wp_customize->add_control( 'homepage_features_button', array(
//                'type'                  => 'text',
//                'section'               => 'homepage_features',
//                'label'                 => __( 'Link Text', 'karma' ),
//            ) );
//

    $wp_customize->add_section( 'static_front_page', array (
        'title' => __( 'Static Front Page', 'karma' ),
        'panel' => 'homepage',
    ) );
    
    $wp_customize->add_section( 'title_tagline', array (
        'title' => __( 'Logo, Title, Tagline & Favicon', 'karma' ),
        'panel' => 'logo',
    ) );
    ...
    $wp_customize->add_control( 'logo_bool', array(
        'type'                  => 'radio',
        'section'               => 'logo',
        'label'                 => __( 'Display Logo', 'karma' ),
        'description'           => __( 'If you do not use a logo, the site title will be displayed', 'karma' ),  
        'choices'               => array(
            'on'              => __( 'Yes', 'karma'),
            'off'             => __( 'No', 'karma'),
        )
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'image_control4', array (
        ...
        'mime_type'             => 'image',
        'settings'              => 'logo',
        'description'           => __( 'Image for your site', 'karma' ),        
    ) ) );
    ...
    $wp_customize->add_panel( 'social', array (
        'title'                 => __( 'Social', 'karma' ),
        'description'           => __( 'Social Icons, Links & Location', 'karma' ),
        'priority'              => 10
    ) );
